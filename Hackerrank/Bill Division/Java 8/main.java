...
class Result {
    ...
    public static void bonAppetit(List<Integer> bill, int k, int b) {
        // Calculate the total bill sum
        int totalSum = bill.stream().mapToInt(Integer::intValue).sum();
        // Calculate what Anna's share of the bill should have been (excluding the k-th item)
